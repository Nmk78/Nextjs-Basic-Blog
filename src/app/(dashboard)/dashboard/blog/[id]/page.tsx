...
import { updatePost, deletePost, getPostById } from '@/features/blog/actions';
import { useToast } from '@/components/ui/use-toast';
import { Loader2, Eye, Edit3, Trash2, ArrowLeft } from 'lucide-react';
...
export default function EditBlogPage({ params }: { params: { id: string } }) {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    toast({
      title: 'Success',
      description: published ? 'Post updated and published!' : 'Post updated.',
    });
    router.push('/dashboard/blog');
    router.refresh();
  }
